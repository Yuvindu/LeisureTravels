            ...
            <div class="container">
              <div class="intro">
                ...
                <p class="text-center">
                  ...
                  the "Leisure travellers" has been committed to bring the
              ...
              <div class="row people">
                <div class="col-md-6 col-lg-4 item">
                  <div class="box">
                    ...
                    <p class="title">Leisure Travelers</p>
                    <p class="description">
                ...
                <div class="col-md-6 col-lg-4 item">
                  <div class="box">
                    ...
                    <p class="description">
                      ...
                      Innovative and Value-Added Services, To Be The Most
                      Professional and Efficient Travel Facilitator, Whilst Being
