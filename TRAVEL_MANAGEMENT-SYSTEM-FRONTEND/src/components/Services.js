  ...
  return (
    <div>
      ...
      <div className="info" style={{background:"hsl(0,0%,50%,0.2)	"}}>
        ...
        >
          <div class="hd">Leisure Travelers Services</div>
          <p>
            ...
            <div class="card col-md-3 col-12 ml-2">
              <div class="card-content">
                <div class="card-body">
                  ...
                  <div class="card-title"> Buy Equipments</div>
                  <div class="card-subtitle">
                    <p>
                      {" "}
                      <small class="text-muted">
          ...
          <div class="ft">
            ...
            <div class="btn btn-primary servicetext"> <a href="/equipment" >Travel Equipments</a></div>&nbsp;&nbsp;
